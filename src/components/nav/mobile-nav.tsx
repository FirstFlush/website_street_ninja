  ...
  const { expanded, toggleNavMenu, closeNavMenu } = useMobileNav()
    ...
    return (
        <motion.div
            ...
            className={clsx(
                "z-1000 absolute inset-x-0 top-full mt-12 mx-3 sm:mx-auto max-w-[500px] flex flex-col origin-top",
            ...
            //     "z-1000",
            //     "absolute inset-x-0 top-full mt-4 mx-3 sm:mx-auto max-w-[500px] flex flex-col origin-top",
            //     "rounded-2xl bg-background-dark/95 p-4 text-lg tracking-tight text-foreground-dark",
            //     "ring-1 shadow-xl ring-slate-900/5",
